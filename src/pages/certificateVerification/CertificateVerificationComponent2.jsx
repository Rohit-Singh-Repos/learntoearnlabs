...
export const CertificateInformation = React.memo(
  ({
    mobileDetector,
    certificateInfoData,
    setShowCertificateInfo,
        ...
        <Div divClass="col-sm-12 col-md-7 col-lg-6">
          ...
          <UnorderedList unorderedListClass="list-group mb-3 ">
            <ListItem listItemClass="list-group-item d-flex justify-content-between align-items-center rounded-0">
              Certificate Code
              <Span spanClass="badge bg-primary rounded-pill">
                {certificateInfoData && certificateInfoData[0]?.certificateCode}
              </Span>
            </ListItem>
            <ListItem listItemClass="list-group-item d-flex justify-content-between align-items-center">
              Candidate Name
              <Span spanClass="badge bg-primary rounded-pill">
                {certificateInfoData && certificateInfoData[0]?.candidateName}
              </Span>
            </ListItem>
            <ListItem listItemClass="list-group-item d-flex justify-content-between align-items-center">
              Enrollment Number
              <Span spanClass="badge bg-primary rounded-pill">
                {certificateInfoData && certificateInfoData[0]?.enrollmentNo}
              </Span>
            </ListItem>
            <ListItem listItemClass="list-group-item d-flex justify-content-between align-items-center">
              Title
              <Span spanClass="badge bg-primary rounded-pill">
                {certificateInfoData && certificateInfoData[0]?.title}
              </Span>
            </ListItem>
            <ListItem listItemClass="list-group-item d-flex justify-content-between align-items-center">
              Completion Date
              <Span spanClass="badge bg-primary rounded-pill">
                {certificateInfoData && certificateInfoData[0]?.completionDate}
              </Span>
            </ListItem>
            <ListItem listItemClass="list-group-item d-flex justify-content-between align-items-center rounded-0">
              Duration
              <Span spanClass="badge bg-primary rounded-pill">
                {certificateInfoData && certificateInfoData[0]?.duration}
              </Span>
            </ListItem>
          </UnorderedList>
