    ...
    <Div divClass="container mt-5">
      <Div divClass='row'>
        <Div divClass="col-lg-12 col-md-12 col-sm-12">
            ...
            <Paragraph paragraphClass="align-justify">As a training unit, we have an active relationship with corporates and industry professionals because building relationships with corporates and industry professionals can bring numerous benefits.</Paragraph>
