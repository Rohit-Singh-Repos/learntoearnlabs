      ...
      <Div divClass="row d-flex justify-content-around align-items-center">
        <Div divClass="col-sm-12 col-md-12 col-lg-6">
          ...
          <Paragraph paragraphClass="align-justify-sm">
            With 12+ years of experience in transforming lives by enabling and
            empowering learners with skills that matter.
          </Paragraph>
        </Div>
        <Div divClass="row col-sm-12 col-md-12 col-lg-6">
          <CommonCard
            verticalAlign={true}
            cardClass="card text-bg-primary col-lg-6 col-sm-12 col-md-6 rounded-0 border border-5 border-light"
          >
          ...
          <CommonCard
            verticalAlign={true}
            cardClass="card text-bg-primary col-lg-6 col-sm-12 col-md-6 rounded-0 border border-5 border-light d-flex"
          >
            <Paragraph paragraphClass="card-text fw-bold text-center">
          ...
          >
            <Paragraph paragraphClass="card-text fw-bold text-center">
              Career Counselling & Job Consultation
            </Paragraph>
          </CommonCard>
        </Div>
      </Div>
