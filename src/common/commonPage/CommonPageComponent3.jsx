    ...
    return (
      <Div divClass="container mt-5 pt-3">
        <Div divClass="row">
            ...
            <Div divClass={mobileDetector ? "col-sm-12 col-md-7 col-lg-7" : "row col-sm-12 col-md-7 col-lg-7 d-flex justify-content-around align-items-center"}>
              {
                cardTextData && cardTextData.length !== 0 ? cardTextData.map((item) => (
                  <CommonCard key={item.id} cardClass="card mt-3 rounded-0 border-0 bg-primary text-light text-center fw-bold col-lg-5 pt-2 pb-2">
